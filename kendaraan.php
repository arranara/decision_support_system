  ...
  <body>
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='tambah_kendaraan.php'> Tambah Data Kendaraan</a>
			<a class='btn btn-primary' href='cetak_kendaraan.php'> Cetak Data Kendaraan</a><br /><br />
			...
			?>
				...
				<td>
				<a href="edit_kendaraan.php?id=<?php echo $data['alternatif'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
				<a onclick="return confirm('hapus kendaraan ini?)" 
				href="hapus_kendaraan.php?id=<?php echo $data['alternatif'];?>" onClick="return confirm('Menghapus data ke-<?php echo $i-1;?> 
				Alternatif <?php echo $data['alternatif'];?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
		<?php
			echo '</tr>';
				}
		?>
