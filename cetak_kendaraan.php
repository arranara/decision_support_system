...
<html>
<head>
	<title>Cetak Data Laporan Kendaraan</title>
</head>
<body>
<style>
			body {
...
<br>
	...
	<table width="80%" align="center" cellspacing="0" cellpadding="2" border="1px" class="style1">
		<tr>
			...
			<td width="6%" bgcolor="#CCCCCC" align="center">Nomor Polisi</td>
   	        <td width="10%" bgcolor="#CCCCCC" align="center">Merk</td>
			<td width="6%" bgcolor="#CCCCCC" align="center">Tahun</td>
   	        <td width="6%" bgcolor="#CCCCCC" align="center">Jenis</td>
		</tr>
		
		<?php 
		$no = 1;
        $result=mysqli_query($result,"SELECT * FROM `kendaraan` ");
