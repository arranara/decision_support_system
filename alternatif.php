  ...
  <body>
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='add-alternatif.php'> Tambah Data Alternatif</a>
			<a class='btn btn-primary' href='cetak_alternatif.php'> Cetak Data Alternatif</a><br /><br />
										...
										<?php
												...
												while ($row = $alternatif->fetch_assoc()) {
													...
													?>
														  ...
														  <a href="del.php?id=<?php echo $row['id_alternatif'];?>" onClick="return confirm('Menghapus data ke-<?php echo $i-1;?> 
														  Alternatif <?php echo $row['alternatif'];?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													<?php
													echo '</tr>';
												}
										?>
